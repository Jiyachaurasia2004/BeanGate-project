    ...
    <div className="min-h-screen relative overflow-hidden ">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-12">
        <div className="w-full max-w-6xl flex gap-8 items-center">
          ...
          {/* Left Side - Benefits (matching signup page) */}
          <div className="hidden lg:flex flex-col flex-1 text-white space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-zinc-600">
                Sign in to manage your IT solutions, track progress, and access premium support.
              </p>
            </div>

            <div className="space-y-4">
              {[
                { icon: CheckCircle2, title: "Instant Dashboard Access", desc: "Real-time insights and analytics at your fingertips", color: "from-orange-500 to-orange-600" },
                { icon: Shield, title: "Secure Login", desc: "Multi-layer security with enterprise-grade encryption", color: "from-orange-600 to-red-600" },
                { icon: Zap, title: "Quick Actions", desc: "Manage all your services from one central hub", color: "from-amber-500 to-orange-500" },
                { icon: TrendingUp, title: "Track Performance", desc: "Monitor your business growth and metrics", color: "from-orange-500 to-yellow-500" }
              ].map((item, i) => (
